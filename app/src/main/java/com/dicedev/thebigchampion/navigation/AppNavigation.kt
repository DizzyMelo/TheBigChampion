...
import com.dicedev.thebigchampion.screens.group.add_player.AddPlayersToGroupScreen
...
fun AppNavigation() {
    ...
    NavHost(
        ...
        builder = {
            ...
            composable(route = "${AppScreens.AddPlayersToGroupScreen.name}/{groupId}", arguments = listOf(
                navArgument(name = "groupId") {
                    type = NavType.StringType
                }
            )) {
                val groupId = it.arguments?.getString("groupId")
                AddPlayersToGroupScreen(navController, groupId)
            }
